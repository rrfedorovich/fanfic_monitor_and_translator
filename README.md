...
Использование приложения состоит из [обновления отслеживаемых фанфиков](#514-указание-фанфиков) (когда нужно) и запуска приложения. Для запуска нужно войти в Replit, затем войти в созданное приложение и нажать кнопку запуска (зеленый треугольник).
